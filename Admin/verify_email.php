...
if(isset($_GET['type'], $_GET['code']))
{
	if($_GET['type'] == 'master')
	{
		...
		$exam->redirect('../Admin/Admin_Login-page.php?verified=success');
	}
	...
	if($_GET['type'] == 'user')
	{
		...
		$exam->redirect('../Student/User_Login-page.php?verified=success');
	}
}
