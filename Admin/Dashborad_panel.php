          ...
          <div class="row">
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card sales-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Today Result Publish <span>| Today</span></h5>
            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card revenue-card">
                ...
                <div class="card-body">
                  <h5 class="card-title">Total Exam <span>| This Month</span></h5>
            ...
            <div class="col-xxl-4 col-xl-12">
                ...
                <div class="card-body">
                    <h5 class="card-title">Total Subject<span>| This Year</span></h5>
